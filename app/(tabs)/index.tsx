  ...
  return (
    <ParallaxScrollView headerBackgroundColor={{ light: "#A1CEDC", dark: "#1D3D47" }} headerImage={<Image source={require("@/assets/images/partial-react-logo.png")} style={styles.reactLogo} />}>
      ...
      <ThemedView style={styles.stepContainer}>
        <Button className="w-full bg-red-500  dark:bg-blue-500 text-white dark:text-white">Test</Button>
        <Pressable className="w-full bg-red-500 dark:bg-red-500">
          <Text className="text-white dark:text-blue-500">Hello there</Text>
        </Pressable>
